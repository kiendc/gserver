class UnitLabel extends React.Component{
    render(){
        if (this.props.militaryBranch == 1)
            return React.createElement("g", { strokeWidth: ".29421726", fill: "#666",  transform: "matrix(1.07958 0 0 1.08033 -.114 -.114)" },
            ...
            return React.createElement("g", { strokeWidth: ".60250032", fill: "#666", fillRule: "evenodd", transform: "matrix(.83088 0 0 .82887 2.548 2.632)" },
                        React.createElement("path", { 
...
class UnitSelector extends React.Component {
    render (){
        //console.log("UnitSelector render()");
        //console.log(this);
        var unit = this.props.unit;
        let orderLabel = 'at  ' + unit.location + ' ';
        return React.createElement("span",{},
                    React.createElement('svg',{
                        id: unit.location + '-' + unit.militaryBranch,
                        height: 20,
                        width: 40,
                    },
                        React.createElement(UnitLabel,{militaryBranch: this.props.unit.militaryBranch})
                    ),
                    orderLabel);
    }
    get(){
